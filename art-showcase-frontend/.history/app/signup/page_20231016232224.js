...
function page() {
  ...
  return (
    ...
    >
      <div className="grid gap-y-1 bg-gradient-to-r from-purple-300 via-pink-400 to-red-400 p-20 h-[80%] max-h-[400px] jutify-center items-center max-w-4rounded-[20px]">
