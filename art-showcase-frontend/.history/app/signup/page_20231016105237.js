...
function page() {
  ...
  return (
    <form
      ...
      className="flex justify-center items-center h-screen sm: grid bg-red-600)"
    >
      <div className="grid gap-y-1 bg-gradient-to-r from-purple-300 via-pink-400 to-red-400 p-20 h-[80%] jutify-center items-center ">
