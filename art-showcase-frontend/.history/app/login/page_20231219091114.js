...
function page() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-formBg">
    <div className="relative w-[100%]">
      ...
      <form
        ...
        className="grid p-8 w-[80%] lg:w-[50%] max-w-[400px] rounded-[20px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
      >
        <Image
          src={logo}
          alt="logo"
        ...
        <input
          type="email"
          name="email"
          className="bg-background text-text p-2 rounded mb-2"
        />
        ...
        <button
          type="submit"
          className="mt-6 bg-primary text-primary p-2 rounded hover:bg-secondary hover:text-white transition-all"
        >
          Login
        </button>
      </form>
