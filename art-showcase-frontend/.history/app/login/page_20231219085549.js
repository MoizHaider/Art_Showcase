...
function page() {
  ...
  return (
    <div>
      <Image src = {flowerCircle} alt = "flower circle" width = {40} heihgt = {40}/> 
      <Image src = {logo} alt = "logo" width = {40} heihgt = {40}/>
      <h2>Art Nest</h2>
      <form
        onSubmit={onSubmitHandler}
        className="flex justify-center items-center h-screen bg-formBg via-pink-400 to-red-400"
      >
