  ...
  return (
    ...
    <div className="relative w-[100%]">
      <Image
        ...
        height={750} // Increase the height
      ...
      >
        <Image
          ...
          width={70}
          height={70}
          className="mb-2 mx-auto shadow-lg"
        />
        <h2 className="text-accent text-lg font-bold text-center">Art Nest</h2>
  
        <label className="text-text mt-4">Email</label>
        <input
          type="email"
          name="email"
          className="text-primary p-2 rounded-full mb-2 w-[90%]"
        />
