    ...
    <>
      <div className="grid grid-cols-profileDesktopGridCols items-start ">
        <header className="col-start-1 col-end-3 h-screen flex flex-col items-center justify-center relative">
          {/* Background image in a circle shape */}
          ...
          {/* Full-width image covering the window */}
          <Image
          ...
          <div className="text-white text-center relative z-10">
            <h1 className="text-3xl font-bold"><TypeWriter className="text-lg font-semibold" text = {data.userData.name}/></h1>
            <h2 className="text-lg font-semibold"><TypeWriter className="text-lg font-semibold" text = {data.userData.title}/></h2>
          </div>
        </header>
