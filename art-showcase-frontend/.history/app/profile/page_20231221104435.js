    ...
    <>
      <div className="grid grid-cols-profileDesktopGridCols items-start ">
        <header className="col-start-1 col-end-3 h-screen flex flex-col items-center justify-center relative">
          <div className="w-48 h-48 rounded-full overflow-hidden absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center relative z-10">
            <Image
