      ...
      <div className="grid grid-cols-profileDesktopGridCols items-start ">
        <header className="col-start-1 col-end-3 h-screen flex flex-col items-center justify-center relative">
          ...
          <div className="w-32 h-32 rounded-full overflow-hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <Image
              //src="/path-to-background-image.jpg" // Replace with the actual path to your background image
              alt="Profile Image"
              layout="fill"
              objectFit="cover"
          ...
          <Image
            src={`${backendAddress+data.userData.profilePicUrl}`} // Replace with the actual path to your full-width image
