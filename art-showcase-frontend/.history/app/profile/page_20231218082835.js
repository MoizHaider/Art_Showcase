      ...
      <div className="grid grid-cols-profileDesktopGridCols items-start ">
        <header className="col-start-1 col-end-3 h-screen flex flex-col items-center justify-center relative">
          ...
          <div className="text-white text-center relative z-10">
            <h1 className="text-3xl font-bold"><TypeWriter>{data.userData.name}</TypeWriter></h1>
            <h2 className="text-lg font-semibold"><TypeWriter>{data.userData.title}</TypeWriter></h2>
          </div>
        </header>
