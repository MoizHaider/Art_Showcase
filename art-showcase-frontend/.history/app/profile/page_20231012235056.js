...
function page() {
  ...
  if(data.posts.length>0){
    data.posts.map(post=><Post type = "userPosts" _id = {post._id} likesCount = {post.likesCount} title = {post.title} description = {post.description} creationDate = {post.creationDate} commentsCount = {post.commentCount}/>)
  }
