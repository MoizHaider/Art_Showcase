    ...
    >
      ...
      >
        <div className="w-[100%] mb-0">
          <div className={`mb-2  w-[${imageWidth}px] flex justify-start gap-x-4 items-center`}>
            <Image src = {profilePicUrl} alt = "profilePic" width={40} height = {40} className = "rounded-full border-[1.5px] border-solid border-text" />
