...
function Post(props) {
  ...
  return (
    <div  style={{background: 'rgba(255, 255, 255, 0)', borderRadius: '16px', boxShadow: '0 4px 30px rgba(0, 0, 0, 0.1)', backdropFilter: 'blur(14.2px)', WebkitBackdropFilter: 'blur(14.2px)', border: 1px solid rgba(255, 255, 255, 0.1)}}>
