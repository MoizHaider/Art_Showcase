...
function Post(props) {
  ...
  return (
    <div className="rounded-[20px]  bg-primaryD w-[60em] py-[2em] flex justify-center mb-[5em] drop-shadow-xl shadow-[5px_3px_20px_rgba(0,0,0,0.7)] bg-transparent rounded-xl shadow-lg backdrop-blur border border-transparent">
      <div className="flex flex-col justify-center items-center bg-darkB p-3">
        <div>UserName</div>
        <Image
          src={imgUrl}
          alt=""
