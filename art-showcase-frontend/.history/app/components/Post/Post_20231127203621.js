...
function Post(props) {
  ...
  return (
    <div className="border-[2px] border-solid border-terteryB p-7 rounded-[20px]  bg-green-300 w-[80%] flex justify-center">
      <div className="flex flex-col justify-center items-center bg-blue-300 p-3 rounded-[10px]">
        <div>UserName</div>
        <img src={imgUrl} alt="" className="w-[400px] h-[500px]" />
        <PostBtns />
        <div className="">
