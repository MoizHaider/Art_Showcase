...
function Post(props) {
  ...
  return (
    <div className="rounded-[20px] w-[60em] py-[0em] flex justify-center  justify-self-center ">
      <div className="flex flex-col justify-center items-center px-[1em] py-[1.5em] rounded-[15px] bg-white">
        <div className="mb-[1em] border-[2px] border">
          <div>UserName</div>
          <span>Img</span>
        </div>
        ...
        <div className = "w-[100%] h-[3px] bg-pink-300 mb-[3em] mt-[4em]">
      </div>
      </div>
