...
function Post(props) {
  ...
  return (
    <div className="rounded-[20px] backdrop-blur-lg backdrop-brightness-50 bg-white/30 w-[60em] py-[1em] flex justify-center mb-[5em] drop-shadow-xl shadow-[5px_3px_20px_rgba(0,0,0,0.7)]">
