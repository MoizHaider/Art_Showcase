      ...
      >
        <div className="w-[100%] bottom-0">
          <div className={`mb-2  w-[${imageWidth}px] flex justify-start gap-x-4 items-center`}>
            <Image src = {profilePicUrl} alt = "profilePic" width={40} height = {30} className = "rounded-full border-[1.5px] border-solid border-text" />
        ...
        <div className="w-full h-1 bg-pink-300 my-4 mt-7"></div>
      </div>
    </div>
  );
}
