...
function Post(props) {
  ...
  return (
    <div className="border-[2px] border-solid border-pink-500 p-7 rounded-[20px]  bg-terteryB w-[80%] flex justify-center ">
      <div className="flex flex-col justify-center items-center bg-primaryD p-3 rounded-[10px]">
        <div>UserName</div>
