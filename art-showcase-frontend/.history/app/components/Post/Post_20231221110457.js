...
let profilePicUrl
  if(props.server){
    profilePicUrl = "http://localhost:8080/" + props.profilePicUrl;
  }
  else{
  ...
  return (
    ...
    >
      <div
        className={`flex flex-col gap-y-5 px-4 py-6 bg-white w-[${imageWidth}px]`}
      >
        <div className="w-[100%]">
          <div className={`mb-2  w-[${imageWidth}px] flex justify-start gap-x-4`}>
            <Image src = {profilePicUrl} alt = "profilePic" width={40} height = {40} className = "rounded-full" />
