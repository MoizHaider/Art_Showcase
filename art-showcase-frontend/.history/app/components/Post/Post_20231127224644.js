...
function Post(props) {
  ...
  return (
    <div className="rounded-[20px] w-[60em] py-[1em] flex justify-center mb-[5em] ">
      <div className="flex flex-col justify-center items-center bg-gray-100 px-[1em] py-[1.5em] rounded-[15px] drop-shadow-[2px_3px-10px_rgb(0,0,0,0.3)] ">
        <div>UserName</div>
        <Image
          src={imgUrl}
          alt=""
