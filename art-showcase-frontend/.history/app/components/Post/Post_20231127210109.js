...
function Post(props) {
  ...
  return (
    <div className="border-[2px] border-solid border-pink-500 p-7 rounded-[20px]  bg-darkB w-[80%] py-0 flex justify-center mb-[5px]">
      <div className="flex flex-col justify-center items-center bg-gray-100 p-3 rounded-[10px] ">
        <div>UserName</div>
        <Image
          src={imgUrl}
          alt=""
          width={400}
          height={400}
          className="w-[400px] h-[400px] border-[10px]"
        />
