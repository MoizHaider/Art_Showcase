...
function Post(props) {
  ...
  return (
    <div className={`max-w-screen-lg mx-auto py-6 flex justify-center w-[${imageWidth}px`}>
      <div className={`flex flex-col  px-4 py-6 bg-white w-[${imageWidth}px]`}>
        <div className={`mb-2  w-[${imageWidth}px] flex justify-start`}>
          <div className={`font-bold text-lg w-[${imageWidth}px]`}>
            <span>Img</span>UserName
          </div>
        </div>
