...
function Post(props) {
  ...
  return (
    <div className="rounded-[20px]  bg-primaryD w-[60em] py-[2em] flex justify-center mb-[5em] drop-shadow-xl shadow-[5px_3px_20px_rgba(0,0,0,0.7)]">
      <div className="flex flex-col justify-center items-center bg-darkB p-3 color-white">
        <div>UserName</div>
        <Image
          src={imgUrl}
          alt=""
