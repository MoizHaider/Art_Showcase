...
function Post(props) {
  ...
  return (
    <div className="border-solid border-gray-500 border-[2px] p-7 rounded-[20px]  bg-darkB w-[60em] py-0 flex justify-center mb-[5em] drop-shadow-xl shadow-[5px_3px_15px]">
