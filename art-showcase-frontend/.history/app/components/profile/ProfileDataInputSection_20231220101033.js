        ...
        <div className="mb-4 flex items-center">
          <div className="w-1/2 pr-4 relative">
            ...
            <input
              ...
              className="mt-1 mb-2 w-full opacity-0 absolute"
            />
            {profileImgUrl && (
              <div className="w-20 h-20 flex items-center justify-center border border-gray-300 rounded-md overflow-hidden">
                <img
                  src={profileImgUrl}
                  alt="Profile Preview"
