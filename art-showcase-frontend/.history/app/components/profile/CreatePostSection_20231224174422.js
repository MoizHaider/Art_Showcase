...
function CreatePostSection(props) {
  ...
  return (
    ...
    {renderAddPostSec ? (
      <div
        className={`z-20 absolute top-0 left-0 h-full flex items-center  bg-black bg-opacity-30 justify-center  w-[100vw] ${
          renderAddPostSec ? "block" : "hidden"
        }`}
      >
        <div className="bg-primary p-8 rounded-lg w-[50%] backdrop-blur backdrop-filter">
