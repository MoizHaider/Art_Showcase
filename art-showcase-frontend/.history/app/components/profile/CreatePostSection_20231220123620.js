...
function CreatePostSection(props) {
  ...
  return (
    <>
      {renderAddPostSec ? (
        <div className={`w-[50%] fixed top-0 left-0 w-full h-full flex items-center backdrop-blur backdrop-filter bg-black bg-opacity-30 justify-center ${renderAddPostSec ? 'block' : 'hidden'}`}>
