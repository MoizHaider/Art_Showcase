    ...
    <>
      {shouldRenderNavigation && (
        <>
          ...
          <nav className="bg-text sticky text-primary flex justify-between w-auto gap-10 p-5 h-[70px] shadow-xl">
            ...
            <div className="flex items-center">
              ...
              <Link href="/profile" className = "mr-4 active:bg-accent">Profile</Link>
              <button type="button" className = "mr-4 text-primary bg-accent border-none" onClick={onBtnClickHandler}>
                Logout
              </button>
            </div>
          </nav>
