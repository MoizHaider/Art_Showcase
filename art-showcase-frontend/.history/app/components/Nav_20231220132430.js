    ...
    <>
      {shouldRenderNavigation && (
        <>
          ...
          <nav className="flex justify-between w-auto gap-10 p-5">
            <div className="flex gap-x-4 items-center ml-4">
              <Image
                ...
                width={50}
                height={50}
                className="mx-auto bg-primary rounded-[10px] "
              />
              <h2 className="text-accent text-lg font-bold text-center shadow-lg">
                Art Nest
              </h2>
            </div>
